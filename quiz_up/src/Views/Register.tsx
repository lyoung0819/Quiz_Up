// - Form that accepts email, first name, last name, and password
// - Event Handler for handling input change and form submit
// - Sends the data to the API to create a new user
...
export default function Register({ }: RegistrationProps) {
